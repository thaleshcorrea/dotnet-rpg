        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                if (characterSkill == null)
                {
                    ...
                    response.Message = $"{attacker.Name} ainda não aprendeu essa skill.";
                }
                ...
                while (!defeated)
                {
                    foreach (Character attacker in characters)
                    {
                        ...
                        if (opponent.HitPoints <= 0)
                        {
                            ...
                            attacker.Victories++;
                            opponent.Defeats++;
                            response.Data.Log.Add($"Soldado {opponent.Name} abatido em combate.");
                            response.Data.Log.Add($"{attacker.Name} abateu o soldado com {attacker.HitPoints} de vida restante.");
                            break;
                        }
                    }
                }
